                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 border border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                        />
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <select
                            ...
                            className="w-full pl-10 pr-4 py-2 border border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 appearance-none"
                        >
                    ...
                    <div>
                        <select
                            ...
                            className="w-full px-4 py-2 border border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                        >
        ...
        <div className="bg-slate-800 rounded-lg shadow-sm border border-slate-700 hover:shadow-md transition-shadow">
            <div className="p-6">
                ...
                <div className="flex gap-2 mb-4">
                    ...
                    {box.pieceType && (
                        <span className="px-2 py-1 bg-slate-700 text-gray-800 text-xs rounded-md font-medium capitalize">
                            {box.pieceType}
                        </span>
                    )}
                </div>
