...
export default function PreSaleHub() {
    ...
    const titleAccentClass = isDark
        ? 'rounded-2xl border border-slate-700/70 bg-[linear-gradient(145deg,rgba(236,72,153,0.24),rgba(15,23,42,0.68))] shadow-[12px_12px_24px_rgba(2,6,23,0.55),-10px_-10px_22px_rgba(236,72,153,0.12)]'
        : 'rounded-2xl border border-white/80 bg-[linear-gradient(145deg,rgba(253,242,248,0.98),rgba(244,114,182,0.14))] shadow-[12px_12px_24px_rgba(148,163,184,0.34),-12px_-12px_24px_rgba(255,255,255,0.96)]'
    ...
    return (
        <div className={`space-y-6 ${pageBackdropClass}`}>
            {/* Header */}
            <div className={`p-4 lg:p-5 ${titleAccentClass}`}>
                        ...
                        return (
                            <button
                                ...
                                className={`
                                    ...
                                    ${isActive
                                        ? (isDark ? 'bg-slate-700/70 text-blue-300 border-b-2 border-blue-500' : 'bg-blue-50 text-blue-600 border-b-2 border-blue-600')
