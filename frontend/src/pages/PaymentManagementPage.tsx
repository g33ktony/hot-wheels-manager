            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex gap-2 border-b border-gray-300">
                    ...
                    <button
                        ...
                        className={`px-4 py-2 font-medium transition-colors border-b-2 ${activeTab === 'analytics'
                                ? 'text-blue-600 border-blue-600'
                                : 'text-gray-600 border-transparent hover:text-gray-800'
                            }`}
                    >
                            ...
                            {overduePayments && overduePayments.length > 0 ? (
                                overduePayments.map((payment: any) => (
                                    <div
                                        ...
                                        className={`bg-white rounded-lg shadow-md p-4 cursor-pointer hover:shadow-lg transition-shadow ${selectedPaymentId === payment._id ? 'ring-2 ring-blue-500' : ''
                                            }`}
                                    >
