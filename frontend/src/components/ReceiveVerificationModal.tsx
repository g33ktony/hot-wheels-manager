        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <div className="p-6">
                    ...
                    <div className="space-y-3 mb-6">
                        ...
                        {purchase.items.map((item, index) => {
                            ...
                            return (
                                <div
                                    key={index}
                                    className={`border-2 rounded-lg p-4 transition-all ${status.received && status.quantity === item.quantity
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="mt-3 flex items-center gap-2">
                                                ...
                                                <input
                                                    ...
                                                    className={`w-20 px-3 py-1 border rounded-lg text-center ${!status.received
                    ...
                    {/* Summary */}
                    <div
                        className={`rounded-lg p-4 mb-6 ${allReceived
