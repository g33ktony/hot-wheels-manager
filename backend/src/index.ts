...
import catalogManagementRoutes from './routes/catalogManagementRoutes'
...
app.use('/api/catalog', authMiddleware, catalogManagementRoutes)
app.use('/api/enrichment', authMiddleware, catalogEnrichmentRoutes)
